        ...
        return(
            <nav className="navbar navbar-expand-lg navbar-light">
                <div className="container-fluid">
                    <Link className="navbar-brand text-capitalize text-danger fs-3" to="/">World Bank</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarScroll">
                        <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
                            ...
                            <li className="nav-item">
                              <Link className="nav-link text-dark fs-5" to="/customers">Customers</Link>
                            </li>
                            <li>
                                <Link className="nav-link text-dark fs-5" to='/transactions'>Transactions</Link>
                            </li>
                        </ul>
                    </div>
                </div>
